...
val primaryColor = Color(0XFFDE0000)
val onPrimaryColor = Color(0XFFFFFFFF)

val tertiaryColor = Color(0xFF8A8A8A)

val surfaceLightColor = Color(0XFFFFFFFF)
val onSurfaceLightColor = Color(0XFF000000)
val surfaceVariantLightColor = Color(0XFFFFFFFF)
val onSurfaceVariantLightColor = Color(0XFF000000)
